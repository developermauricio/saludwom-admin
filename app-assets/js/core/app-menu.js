      ...
      if (this.expanded === false) {
        if ($body.data('menu') == 'vertical-menu-modern') {
          $('.modern-nav-toggle')
            ...
            .replaceWith(
              "<img class='d-none d-xl-block collapse-toggle-icon primary font-medium-4' width='20'  src='feather/disc.svg' alt=''/>"
      ...
      if (this.collapsed === false) {
        if ($body.data('menu') == 'vertical-menu-modern') {
          $('.modern-nav-toggle')
            .find('.collapse-toggle-icon')
            .replaceWith(
              "<img class='d-block d-xl-block collapse-toggle-icon primary font-medium-4' width='200'  src='../../../feather/circle.svg' alt=''/>"
