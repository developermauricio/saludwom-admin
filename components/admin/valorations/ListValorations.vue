...
export default {
  ...
  methods: {
    ...
    async getValorations() {
      ...
      await this.$axios.get(`/api/v1/get-valorations/${JSON.stringify(this.dateFilter)}/?genderId=${this.valueFilterGender}&state=${this.valueFilterState}&plan=${this.valueFilterPlan}&doctor=${this.valueFilterDoctor}`).then(resp => {
