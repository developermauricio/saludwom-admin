<template>
  <div>
    <div class="p-3">
      ...
      <FormDoctor :doctor="doctor" ref="formDoctor"/>
      <div class="row">
    ...
    editDoctor(){
      ...
      this.$swal.fire(
        ...
        if (result.value) {
          ...
          this.$axios.post(`api/v1/edit-doctor/${this.doctor.id}`, this.form).then(async resp => {
            this.$toast.success("El especialista se actualizó correctamente.");
            ...
            this.$vs.loading.close()
            console.log(e)
            this.$toast.error("Error al actualizar el especialista. Consulte a soporte SaludWom.");
          })
        }
      })
